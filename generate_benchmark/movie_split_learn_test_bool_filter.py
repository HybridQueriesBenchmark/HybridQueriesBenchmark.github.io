...
if __name__ == '__main__':
    split_csv('./metadata/movie/movie_bool_filter.csv', './metadata/movie_learn_filter.csv', './metadata/movie_test_filter.csv',
              ['select_clause', 'join_clause', 'where_clause'], LEARN_SIZE)
    print('Done')
